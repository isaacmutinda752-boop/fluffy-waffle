document.addEventListener("DOMContentLoaded", () => {
  ...
  if (loginForm) {
    loginForm.addEventListener("submit", (e) => {
      ...
      if (email === "isaacmutinda752@gmail.com" && password === "admin123") {
        localStorage.setItem("adminSession", "true");
        window.location.href = "adminportal.html";
      } else {
        alert(
          "Invalid credentials. Please use: isaacmutinda752@gmail.com / admin123",
        );
      }
    });
  }
  ...
  if (passwordForm) {
    passwordForm.addEventListener("submit", (e) => {
      ...
      // In a real app, you'd validate the current password and then update it
